...
function show_custom_meta_box( $custom_meta_fields ) {
  ...
  echo '<style>
    ...
    .metabox-form__item--textarea label {
      display: none;
    }
	...
	foreach ( $custom_meta_fields as $field ) {
		...
		echo '<div class="metabox-form__item metabox-form__item--' . $field['type'] . '">
				...
				switch( $field['type'] ) {
					...
					// textarea
					case 'textarea':
						echo '<textarea name="' . $field['id'] . '" id="' . $field['id'] . '" rows="10" placeholder="' . $field['label'] . '">' . $meta . '</textarea>
									<div class="metabox-form__description">' . $field['desc'] . '</div>';
						break;
