...
Seven — бесплатная тема для Вордпресса с акцентом на оформление. Ключевая идея темы: блог должен выглядеть как журнал, а не как газета.

## Планы

* Улучшение РСС
* Возможность кастомизации темы
* Упрощение процесса верстки постов
* Переработка мобильной версии в сторону увеличения размера шрифта
